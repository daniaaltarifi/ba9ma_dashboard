...
function TeacherUpdateCourse() {
  ...
  const fetchLinks = async () => {
    try {
      const response = await axios.get(
        `${API_URL}/Courses/links/${updateTeacherId}`
      );
  ...
  const fetchVideos = async () => {
    try {
      const response = await axios.get(
        `${API_URL}/Courses/videos/${updateTeacherId}`
      );
  ...
  const getTeacherCourseById = async (teacherEmail, updateTeacherId) => {
    try {
      const response = await axios.get(
        `${API_URL}/TeacherRoutes/teacher-course/${updateTeacherId}?teacherEmail=${encodeURIComponent(
          teacherEmail
        )}`
      );
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${API_URL}/TeacherRoutes/updatecourseteacher/${updateTeacherId}`,
        formData,
        {
          headers: {
